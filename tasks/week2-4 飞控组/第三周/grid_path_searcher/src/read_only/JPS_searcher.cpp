        ...
        */         
        for(int i = 0; i < (int)neighborPtrSets.size(); i++){
            ...
            */
            ...
            if(neighborPtr -> id == 0){ //discover a new node
            ...
            else if(tentative_gScore <= neighborPtr-> gScore&&neighborPtr -> id == 1){ //in open set and need update
                /*
                *
                *
                ...
                *        
                */
		neighborPtr->gScore = tentative_gScore;//从当前节点走到邻近节点需要的
                neighborPtr->fScore = neighborPtr->gScore + getHeu(neighborPtr,endPtr);//F=G+H   
                neighborPtr->cameFrom = currentPtr; //父节点
