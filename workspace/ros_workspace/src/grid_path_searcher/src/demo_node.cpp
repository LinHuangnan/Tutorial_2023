...
int main(int argc, char** argv)
{
    ...
    _map_sub  = nh.subscribe( "map",       1, rcvPointCloudCallBack );//订阅到地图信息的回调函数
    _pts_sub  = nh.subscribe( "waypoints", 1, rcvWaypointsCallback );//订阅到中点的回调信息
    ...
    _max_z_id = (int)(_z_size * _inv_resolution);
      //定义结构体AStarpathfinder变量 该结构体存储实现了Astar路径规划所需的所有信息和功能
