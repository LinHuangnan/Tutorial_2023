...
set(MSG_I_FLAGS "-Ilittle_car:/home/kr/ros_project/src/little_car/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kr/ros_project/src/little_car/msg/Car.msg" NAME_WE)
add_custom_target(_little_car_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "little_car" "/home/kr/ros_project/src/little_car/msg/Car.msg" ""
)
...
_generate_msg_cpp(little_car
  "/home/kr/ros_project/src/little_car/msg/Car.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/little_car)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/little_car\")")
  # install generated code
  install(
