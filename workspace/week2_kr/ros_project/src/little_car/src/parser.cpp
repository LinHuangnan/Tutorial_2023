...
void little_car::update_()
{
	...
	_velocity.x = sqrt(_velocity.x * _velocity.x + _velocity.y * _velocity.y)*cos(_yaw);
	_velocity.y = sqrt(_velocity.x * _velocity.x + _velocity.y * _velocity.y)*sin(_yaw);
